...
public class GreaterEqNode extends BinaryExpNode {
    ...
    public String codegen(support.CodeGenerator codeGen) {
        ...
        if (codeGen instanceof support.AccumulatorCodeGenerator) {
            ...
            // Perform comparison: $t1 >= $a0 is !(t1 < a0)
            codeGen.emit("slt " + support.AccumulatorCodeGenerator.ACCUMULATOR + ", " + support.AccumulatorCodeGenerator.TEMP_RESULT + ", " + support.AccumulatorCodeGenerator.ACCUMULATOR, "Check if " + support.AccumulatorCodeGenerator.TEMP_RESULT + " < " + support.AccumulatorCodeGenerator.ACCUMULATOR);
            ...
            // Perform comparison: reg1 >= reg2 is !(reg1 < reg2)
            codeGen.emit("slt " + reg1 + ", " + reg1 + ", " + reg2, "Check if reg1 < reg2");
